  ...
  <header>
    <div class="header_top">
     <ul class="header_tip">
      ...
      <a href="#" class="logo"></a>
    	<ul class="nav">
           <li><a target="bottomFrame" href="${pageContext.request.contextPath}/user_findAll.action">用户管理</a></li>
	       <li><a target="bottomFrame" href="${pageContext.request.contextPath}/user_findwtAll.action">系统维护</a></li>
	     </ul>
    </div>
