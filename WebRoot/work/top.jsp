  ...
  <header>
    <div class="header_top">
     <ul class="header_tip">
      ...
      <a href="#" class="logo"></a>
    	<ul class="nav">
           <li><a target="bottomFrame" href="${pageContext.request.contextPath}/specimen_findAll.action">标本管理</a></li>
	       <li><a target="bottomFrame" href="${pageContext.request.contextPath}/specimen_findjsAll.action">标本接收</a></li>
	        <li><a target="bottomFrame" href="${pageContext.request.contextPath}/history_findshAll.action">病例审核</a></li>
