...
<div class="formbody" >
  <div class="place">
    <span>位置：</span>
    <ul class="placeul">
    <li><a href="#">未审核病例信息列表</a></li>
    </ul>
  </div>
    
    <div class="rightinfo">
    
    <s:form action="history_findshAll.action" method="post" namespace="/" theme="simple">
     <table class="tab1">
						<tbody>
							<tr>
        ...
        <tbody>  
         <s:iterator var="s" value="list">       
	        	 <tr>
	        	 	...
	        	 	<td>
	        	 		<a href="history_shUI.action?id=<s:property value="#s.id"/>" class="tablelink click">审核</a>
	        	 	</td>
	        	 </tr>
	      	</s:iterator>
	        </tbody>
...
<td align="left" style="font-size:13px; color:#dc4e00;">
   ...
   <span>
       ...
       <a href="${pageContext.request.contextPath}/specimen_findshAll.action?currPage=1">[首页]</a>&nbsp;&nbsp;
       <a href="${pageContext.request.contextPath}/specimen_findshAll.action?currPage=<s:property value="currPage-1"/>">[上一页]</a>&nbsp;&nbsp;
    </s:if>
    <s:if test="currPage!=totalPage">
       <a href="${pageContext.request.contextPath}/specimen_findshAll.action?currPage=<s:property value="currPage+1"/>">[下一页]</a>&nbsp;&nbsp;
       <a href="${pageContext.request.contextPath}/specimen_findshAll.action?currPage=<s:property value="totalPage"/>">[尾页]</a>&nbsp;&nbsp;
    </s:if>
   </span>
</td>
</tr>
