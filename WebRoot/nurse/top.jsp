    ...
    <div class="header_top">
      ...
      <a href="#" class="logo"></a>
    	<ul class="nav">
           ...
           <li><a target="bottomFrame" href="${pageContext.request.contextPath}/history_findAll.action">病例信息</a></li>
           <li><a target="bottomFrame" href="${pageContext.request.contextPath}/patient_findAll.action">患者信息</a></li>
           <li><a target="bottomFrame" href="${pageContext.request.contextPath}/specimen_findstateAll.action">标本追溯</a></li>
	     </ul>
    </div>
